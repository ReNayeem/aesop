      ...
      <Navbar expand="lg" className="bg-body-tertiary navbar" id="navbar">
        <Container fluid>
          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            <Nav.Link href="#action1" className="nav-link nav-link-2 nav-link-11">Cart</Nav.Link>
          </Navbar.Collapse>
        </Container>
      </Navbar>
    </div>
